...
Ent1 = Entry(window, bd=2, justify="center", fg="blue", bg="red")
Ent1.grid(row=0, column=0)
Ent1.insert(0, "row 0, column 0")

Ent2 = Entry(window, bd=2, justify="center", fg="blue", bg="red")
Ent2.grid(row=0, column=1)
Ent2.insert(0, "row 0, column 1")

Ent3 = Entry(window, bd=2, justify="center", fg="blue", bg="red")
Ent3.grid(row=0, column=2)
Ent3.insert(0, "row 0, column 2")

Ent4 = Entry(window, bd=2, justify="center", fg="red", bg="blue")
Ent4.grid(row=1, column=0)
Ent4.insert(0, "row 1, column 0")

Ent5 = Entry(window, bd=2, justify="center", fg="red", bg="blue")
Ent5.grid(row=1, column=1)
Ent5.insert(0, "row 1, column 1")

Ent6 = Entry(window, bd=2, justify="center", fg="red", bg="blue")
Ent6.grid(row=1, column=2)
Ent6.insert(0, "row 1, column 2")

Ent7 = Entry(window, bd=2, justify="center", fg="white", bg="black")
Ent7.grid(row=2, column=0)
Ent7.insert(0, "row 2, column 0")

Ent8 = Entry(window, bd=2, justify="center", fg="white", bg="black")
Ent8.grid(row=2, column=1)
Ent8.insert(0, "row 2, column 1")

Ent9 = Entry(window, bd=2, justify="center", fg="white", bg="black")
